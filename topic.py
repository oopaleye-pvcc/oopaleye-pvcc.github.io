...
# Prog Purpose: This program finds a random number for out C.E. Project topic using a Python LIST
...
def main(): 
	...
	generate_another_randomnumber = True  #boolean variable to control the outer loop
	continue_search = True 	#boolean to control the inner loop
	
	while generate_another_randomnumber: # OUTER LOOP
		...
		if num_used_topics == TOTAL_TOPICS:
			...
			if answer.upper() == "n" or answer.upper() == "N":
				generate_another_randomnumber =  False 
main()
